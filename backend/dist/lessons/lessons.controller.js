...
let LessonsController = class LessonsController {
    lessonsService;
    cloudinaryService;
    constructor(lessonsService, cloudinaryService) {
    ...
    async uploadVideo(file, courseId, createLessonDto) {
...
__decorate([
    (0, common_1.Post)(":courseId/upload-video"),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)("video")),
    __param(0, (0, common_1.UploadedFile)()),
    __param(1, (0, common_1.Param)("courseId", common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, create_lesson_dto_1.CreateLessonDto]),
